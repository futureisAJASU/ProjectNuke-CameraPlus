...
internal fun writeColorJobJson(
    ...
    val json = JSONObject()
        ...
        .put("yuvReceivedFrames", yuvReceivedFrames ?: previousJob?.optNullableInt("yuvReceivedFrames") ?: JSONObject.NULL)
        .put("yuvPersistedFrames", yuvPersistedFrames ?: previousJob?.optNullableInt("yuvPersistedFrames") ?: JSONObject.NULL)
        .put("yuvFailedFrames", yuvFailedFrames ?: previousJob?.optNullableInt("yuvFailedFrames") ?: JSONObject.NULL)
        .put("yuvDroppedFrames", yuvDroppedFrames ?: previousJob?.optNullableInt("yuvDroppedFrames") ?: JSONObject.NULL)
        .put("yuvCompletedResults", yuvCompletedResults ?: previousJob?.optNullableInt("yuvCompletedResults") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureClass", yuvFirstWorkerFailureClass ?: previousJob?.optNullableString("yuvFirstWorkerFailureClass") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureMessage", yuvFirstWorkerFailureMessage ?: previousJob?.optNullableString("yuvFirstWorkerFailureMessage") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureFrameIndex", yuvFirstWorkerFailureFrameIndex ?: previousJob?.optNullableInt("yuvFirstWorkerFailureFrameIndex") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureRootCauseClass", yuvFirstWorkerFailureRootCauseClass ?: previousJob?.optNullableString("yuvFirstWorkerFailureRootCauseClass") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureRootCauseMessage", yuvFirstWorkerFailureRootCauseMessage ?: previousJob?.optNullableString("yuvFirstWorkerFailureRootCauseMessage") ?: JSONObject.NULL)
        .put("yuvFirstWorkerFailureStage", yuvFirstWorkerFailureStage ?: previousJob?.optNullableString("yuvFirstWorkerFailureStage") ?: JSONObject.NULL)
